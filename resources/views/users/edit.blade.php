...
<x-app-layout>
    <div class="card m-3">
        ...
        <form id="form_update" action="{{route('user.update', $user->id)}}" method="post">
            @method('patch')
            @csrf
            <div class="card-body">
                ...
                <div  class="row">
                    ...
                    <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            value="{{ $user->firstname }}" autofocus class="form-control">
                        </div>
                    ...
                    <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            autocomplete="email" value="{{ $user->email }}" class="form-control">
                        </div>
                        <span class="help-block"></span>
                    </div>
                    <div class="col-12 col-md-6 mt-2">
                            ...
                            <select id="code" name="code" class="form-control select-2">
                                @foreach ($countries as $item)
                                    <option value="{{$item->id}}"
                                        {{ ($user->phone_code_id == $item->id) ? 'selected' : ''}}>
                                        +{{$item->phone_code}}
                                    </option>
                                @endforeach
                                @if ($user->phone_code_id == null)
                                <script>
                                    $("#code").val("");
                                </script>
                                @endif
                    ...
                    <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            value="{{ $user->phone }}" class="form-control numbers">
                        </div>
                        <span class="help-block"></span>
                    </div>
                    <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <select id="country" name="country" class="form-control select-2">
                                @if ($user->city_id)
                                    @foreach ($countries as $item)
                                    <option value="{{$item->id}}"
                                        {{ ($user->city->state->country->id == $item->id) ? 'selected' : ''}}>{{$item->name}}
                                    </option>
                                    @endforeach
                                @else
                                    @foreach ($countries as $item)
                        ...
                        <div class="input-group">
                            ...
                            {{ $user->city_id ? '' : 'disabled'}}>
                                ...
                                @foreach ($states as $item)
                                    <option value="{{$item->id}}"
                                        {{ ($user->city->state->id == $item->id) ? 'selected' : ''}}>{{$item->name}}
                                    </option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            <select id="city" name="city" class="form-control select-2"
                            {{ $user->city_id ? '' : 'disabled'}}>
                                @if ($user->city_id)
                                @foreach ($cities as $item)
                                    <option value="{{$item->id}}"
                                        {{ ($user->city->id == $item->id) ? 'selected' : ''}}>{{$item->name}}
                                    </option>
                                @endforeach
                                @endif
                            </select>
                    ...
                    <div class="col-12 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            autocomplete="street-address" value="{{ $user->address }}" class="form-control">
                        </div>
                        <span class="help-block"></span>
                    </div>
                    <div class="col-12 mt-2">
