...
@section('rsc_top')
    ...
    <script src="{{ asset('js/cities/edit.js') }}" defer></script>
@endsection
...
<x-app-layout>
    <div class="card m-3">
        ...
        <form id="form_update" action="{{route('city.update', $city->id)}}" method="post">
            @method('patch')
            @csrf
            <div class="card-body">
                ...
                <div  class="row">
                    ...
                    <div class="col-12 col-md-6 mt-2">
                        ...
                        <div class="input-group">
                            ...
                            maxlength="200" value="{{ $city->name }}" class="form-control">
                        </div>
